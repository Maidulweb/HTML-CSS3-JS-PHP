...
<div class="container">
    ...
    <form action="" method="post">
       ...
       if (isset($_POST['edit'])){
           ...
           $name = $_POST['name'];
           $phone = $_POST['phone'];
           $sql = "UPDATE name SET name = '$name', phone = '$phone' WHERE id = '$id' ";
           $result = mysqli_query($conn, $sql);
           header("Location: name.php?editStatus");
       }
        ...
        <div class="col-md-6">
                ...
                <table class="table">
                    ...
                    <tr>
                        ...
                        <td><a href="name.php?edit&id= <?php echo $id;?>">Edit</a>/
                            <a href="name.php?delete&id= <?php echo $id;?>">Delete</a></td>
            ...
            if (isset($_GET['delete'])){
                ...
                $result = mysqli_query($conn, $sql);
                header("Location: name.php?deleteStatus");
            }
            ?>
        </div>
    </div>
